...
if($hasil){
    echo"<script>alert('Data Berhasil Diedit!');location.href='../setelanakun.php?id=".$id."';</script>";
} else
    echo"<script>alert('Terjadi Kesalahan!');location.href='../setelanakun.php?id=".$id."';</script>";
?>