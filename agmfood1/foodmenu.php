...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <div class="page-container2">
                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Menu Makanan</li>
                                        </ul>
                                    </div>
            ...
            <section class="statistic">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                         <?php
                            $sql = 'SELECT * FROM food WHERE tipe="makanan" ORDER BY nama ASC';
                                        ...
                                        <img class="card-img-top mx-auto d-block" src="data:image/jpeg;base64,<?php echo base64_encode($row["gambar"]);?>" alt="Card image cap" style="width:220px;height:200px; object-fit: cover;">
                                            ...
                                            <div class="text-sm-center">
                                                <div class="option">
                                                    ...
                                                    <a href="process/proses_hapusproduk.php?id=<?php echo $row['id_makanan']; ?>" onclick="return confirm('Yakin ingin hapus?');">
				                        ...
				                        <div class="modal-dialog modal-sm" role="document">
					                        <div class="modal-content">
						                        <div class="modal-header">
							                        <h4 class="modal-title" id="staticModalLabel">Tambah Makanan</h4>
							                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
								                            <span aria-hidden="true">&times;</span>
							                        </button>
						                        </div>
						                    <div class="modal-body">
							                    <form action="process/proses_tambahproduk.php" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="text-sm-center">
                                                        <input type="text" value="makanan" name="tipe" hidden> 
            ...
            <!--edit modal-->
            <?php
                $sql = 'SELECT * FROM food WHERE tipe="makanan"';
                $query = mysqli_query($con, $sql);
                while ($row = mysqli_fetch_array($query))
                {
            ?>
            <div class="modal fade" id="staticModal-<?php echo $row['id_makanan'];?>" tabindex="-1" role="dialog" aria-labelledby="staticModalLabel" aria-hidden="true" data-backdrop="static">
				                        <div class="modal-dialog modal-sm" role="document">
					                        <div class="modal-content">
						                        <div class="modal-header">
							                        <h4 class="modal-title" id="staticModalLabel">Edit Makanan</h4>
							                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
								                            <span aria-hidden="true">&times;</span>
							                        </button>
						                        </div>
						                    <div class="modal-body">
							                    <form action="process/proses_editproduk.php" method="post" enctype="multipart/form-data">
                                                ...
                                                <strong>Gambar Produk :</strong><br>
                                                    ...
                                                    <div class="text-sm-center mb-2">    
                                                        ...
                                                        <input class="col border rounded mt-1" type="text" value="makanan" name="tipe" hidden>  
                                                    </div>
                                                    <strong>Deskripsi Produk :</strong>
                                                    <div class="text-sm-center">
